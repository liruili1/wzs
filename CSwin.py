...
class cswin_tiny(CSWin):
    def __init__(self, **kwargs):
        super(cswin_tiny, self).__init__(patch_size=4, embed_dim=64, depth=[1,2,21,1],num_heads=[2,4,8,16],
...
class cswin_small(CSWin):
    def __init__(self, **kwargs):
        super(cswin_small, self).__init__(patch_size=4, embed_dim=64, depth=[2,4,32,2],num_heads=[2,4,8,16],
...
class cswin_base(CSWin):
    def __init__(self, **kwargs):
        super(cswin_base, self).__init__(patch_size=4, embed_dim=96, depth=[2,4,32,2],num_heads=[4,8,16,32],
